...
package hyperhexcast

import kotlin.io.path.div
import libs

plugins {
    id("hyperhexcast.java")
...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/hyperhexcast.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: hyperhexcast-common-common-refmap.json
        // fixed:   hyperhexcast-common.refmap.json
