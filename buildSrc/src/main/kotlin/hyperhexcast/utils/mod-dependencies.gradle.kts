...
abstract class HyperhexcastModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HyperhexcastModDependenciesExtension>("hyperhexcastModDependencies")
