...
loom {
    forge {
        ...
        mixinConfig(
            "hyperhexcast-common.mixins.json",
            "hyperhexcast-forge.mixins.json",
        )
    }
    ...
    runs {
        for ((platform, outputProject) in arrayOf(
            ...
            register("${platform}Datagen") {
                ...
                property("hyperhexcast.apply-datagen-mixin", "true")
                property("hyperhexcast.$platform-datagen", "true")
            }
        }
    }
}

hyperhexcastModDependencies {
